def subnetMask(chiave):
    dizioSubnet = {0:"0.0.0.0",1:"128.0.0.0",2:"192.0.0.0",3:"224.0.0.0",
    ...
    return (dizioSubnet[int(chiave)])

ip_address = ["198.168.222.0/27","192.168.100.0/24","192.168.200.0/28","192.168.50.0/22"]
f = open("c:/Users/Client/Desktop/SHULKER BOX/SCUOLA/4a/SISTEMI E RETI/TEORIA/PYTHON/mask.txt","w")
for cella in ip_address:
    ipv4 = subnetMask(cella[-2:])
    f.write(f"{ipv4}\n")
